...
function f2() {
    let newElem = document.querySelector('.i-2').value;
    s2.add(newElem);
...
function f3() {
    let newElem = document.querySelector('.i-3').value;
    s3.delete(newElem);
...
function f4() {
    ...
    document.querySelector('.out-4').textContent = s4.has(elem);
}
...
function f6() {
    let elemAmount = new Set(a6).size;
    document.querySelector('.out-6').textContent = elemAmount;
}
...
function f7() {
    ...
    if (pass.length === new Set(pass).size && pass.length > 6) {
        out = 1;
    }
...
let s8 = new Set([
    [1, 2, 3, 4, 5, 3, 4, 7, 9, 5, 7, 8, 9, 23, 45, 5, 2, 4, 5, 3, 24, 5, 2, 4, 56, 4, 3, 2, 335, 2, 23, 41, 3, 4, 1, 1, 4, 2, 2, 4, 5, 24, 5, 3, 22, 56]
]);

function f8() {
    let res8 = Array.from(s8).flat().filter(x => x > 5);
...
function f9(our_set) {
    let str = Array.from(our_set).join(' ');
