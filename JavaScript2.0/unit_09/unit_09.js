...
function f5() {
    output5.textContent = out4.classList.contains('bg-4') ? true : false;
}
...
function f13() {
    ...
    btn.textContent = 'pushMe';
    btn.classList.add('bg-13');
    btn.onclick = f13_1;
    output13.appendChild(btn);
}
...
function f18() {
    output18.textContent = p18.getAttribute('data-b');
}
...
function f20() {
    output20.setAttribute('title', 'go');
}
