...
// Произошло преобразование типов. Число 5 преобразовалось в строку и 'склеилось' со строкой '3'.
...
function t9() {
    ...
    output9.textContent = inputValue9;
    inputValue9 = '';
}
...
function t10() {
    ...
    output10.textContent = inputValue10 * 10;
}
...
function t11() {
    ...
    output11.textContent = inputValue11 + 10;
}
...
function t12() {
    ...
    output12.textContent = 'Hello ' + name + ' ' + surname;
}
...
function t13() {
    let num1 = +input13_1.value;
    let num2 = +input13_2.value;
    output13.textContent = num1 + num2;
}
...
let input1 = document.querySelector('.i-16_1');
let input2 = document.querySelector('.i-16_2');
input1.type = 'number';
input2.type = 'number';
...
function t16() {
    ...
    output16.textContent = num1 + num2;
}
...
function t19() {
    let num1 = parseInt(input19_1.value);
    let num2 = parseInt(input19_2.value);
    output19.textContent = num1 + num2;
}
...
function t20() {
    output20.textContent = 'Уважаемый ' + nameInput.value + ', ' + surnameInput.value + ', ваш возраст ' + ageInput.value + ' лет, по профессии вы ' + profession.value;
}
